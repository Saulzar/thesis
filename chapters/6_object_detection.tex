...
In all experiments in this work, the learning rate is set to $0.001$ in all cases and the balance factor $\lambda=2.5$. Total loss is averaged across each mini-batch, and batch sizes of $8$ are used.
