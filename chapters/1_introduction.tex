...
The following publications were produced over the duration of this work, large parts are included in this thesis in a modified form. The remainder of the thesis from Chapter~\ref{chap:design} onward is comprised of not yet published work.

\begin{itemize}
\item Omitted from this thesis, but produced during this work is \cite{Batchelor2013a}, titled, ``Cloud Haskell: First impressions and applications to processing large image datasets''.
\item Chapter \ref{chap:focus} is comprised of work published in \cite{Batchelor2017}, titled ``The role of focus in object instance recognition''.
\item Chapter~\ref{chap:metric} is largely comprised of work published in \cite{Batchelorc}, titled  ``Object Recognition by Stochastic Metric Learning''.
