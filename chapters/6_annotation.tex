...
\centering
\begin{subfigure}[t]{0.5\linewidth}
  \includegraphics[width=1.0\linewidth]{figures/annotation/penguin/hallet_large.jpg}
  \caption{}
\end{subfigure}%
\begin{subfigure}[t]{0.5\linewidth}
  \includegraphics[width=1.0\linewidth]{figures/annotation/penguin/hallet.jpg}
  \caption{}
\end{subfigure}
\begin{subfigure}[t]{0.5\linewidth}
  \includegraphics[width=1.0\linewidth]{figures/annotation/penguin/cotter_large.jpg}
  \caption{}
\end{subfigure}%
\begin{subfigure}[t]{0.5\linewidth}
  \includegraphics[width=1.0\linewidth]{figures/annotation/penguin/cotter.jpg}
  \caption{}
\end{subfigure}
...
\caption{Examples from the Adelie penguin census data taken in 2017. In (a) a crop form the Cape Hallet image showing clearly visible, easy to identify penguins. In (b) a crop from the Cape Cotter image showing a many more difficult examples, often with a high degree of ambiguity for a human annotator (high aleatoric uncertainty). }
