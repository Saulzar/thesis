...
I discuss some novel methods such as using the machine model to assist in reviewing annotations previously, for quality assurance and discuss a novel method of user interaction where two thresholds are used to reduce the burden of an annotator and focus as much as possible on one task at a time.
