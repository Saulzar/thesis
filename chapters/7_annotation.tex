...
% \begin{table}[ht]
%   \centering
%     \caption{Training on all images together. }
%   \begin{tabular}{ l  l  l  l  l }
%     Total & Images & Validation & mAP@0.5 \\
%     \toprule
%     Cape Hallett  & 4217 & 100 & 683, 973, 477 & 0.98 \\
%     Cape Cotter   & 6180 & 100 &  & 0.75  \\
%     Cape Royds    & 2754 & 61 &   & 0.88 \\
%     \bottomrule
%   \end{tabular}
% \label{fig:penguin_statistics}
% \end{table}
